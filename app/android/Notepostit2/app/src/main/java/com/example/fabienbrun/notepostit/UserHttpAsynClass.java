...
public class UserHttpAsynClass extends AsyncTask<Integer, Float, String> {
    ...
    protected void onPostExecute(String result) { if(result == null || result.isEmpty()) {
        ...
        ArrayList<User> list = new Gson().fromJson(result, listType);
        ...
        MySingleton.getInstance().setUsersList(list);
